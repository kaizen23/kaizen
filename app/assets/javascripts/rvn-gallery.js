/*
 * jQuery rvnGallery v2.2
 
 * Copyright 2012, Krukowski Bartłomiej
 * http://rvn-gallery.sirkruk.com
 * Date: 2012.05.20
...
(function($) {
	...
	var RVN_DATA_KEY = 'http://rvn-gallery.sirkruk.com';	
	...
	function rvnSetLink(gallery, _href){
		href = (typeof _href == 'undefined')?'':_href;
		$('.rvnLink', gallery).attr('href', href).
		css({
